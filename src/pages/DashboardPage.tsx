...
import { User, Target, TrendingUp, Plus, Edit3, Calendar, Weight } from 'lucide-react';
...
const mockPublications = [
  {
    ...
    content: "He logrado perder 2kg este mes siguiendo una rutina constante de ejercicio y alimentación saludable.",
    author: "Ana García",
  ...
  },
  {
    ...
    content: "Quiero compartir mi receta favorita que me ha ayudado mucho en mi proceso. Es súper fácil y deliciosa.",
    author: "Ana García",
...
const Dashboard: React.FC = () => {
  ...
  const progressPercentage = Math.min(100, (progress.currentWeight / progress.goalWeight) * 100);
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                {publications.map((pub) => (
                  <div key={pub.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow duration-200">
                    ...
                    <div className="flex items-center gap-2 text-xs text-gray-500">
                      <div className="flex items-center justify-center w-6 h-6 bg-violet-100 rounded-full">
                        <span className="text-xs font-semibold text-violet-700">{user.avatar}</span>
                      </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-gray-900">{publications.length}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-green-600">{(100 - progressPercentage).toFixed(0)}%</span>
                </div>
              </div>
            </div>
          </div>
